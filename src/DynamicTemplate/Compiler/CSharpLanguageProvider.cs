...
");
        ...
        return ___output.ToString();
            ...
            CompilerResults results = new CSharpCodeProvider().CompileAssemblyFromSource(p, _value.ToString());
        ...
        private class InvokeAdapter
        {
            ...
            public string Invoke(object state, object[] values)
            {
                return (string)_method.Invoke(null, new object[] { state, values });
            }
        }
    }
}
